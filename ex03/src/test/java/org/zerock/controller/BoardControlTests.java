...
//	@Test
	public void testGet() throws Exception {
		ModelMap result = mockMvc.perform(MockMvcRequestBuilders.get("/board/get")//
				.param("bno", "1"))//
				.andReturn()//
				.getModelAndView()//
				.getModelMap()//
	...
	public void testModify() throws Exception {
		String result = mockMvc.perform(//
				MockMvcRequestBuilders.post("/board/modify")//
						.param("bno", "1")//
						.param("title", "mock modify title")//
						.param("content", "mock modify content")//
						.param("writer", "user01")//
		)//
				.andReturn()//
				.getModelAndView()//
